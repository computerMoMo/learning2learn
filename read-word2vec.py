...
if __name__=="__main__":    
    ...
    print "loading data...",
    revs, vocab = build_data_cv(data_path+sys.argv[1],data_path+sys.argv[2],cv=10, clean_string=False)
    ...
    cPickle.dump([revs, W, W2, word_idx_map, vocab], open(data_path+sys.argv[3], "wb"))
